...
public class SlidingXYDataset extends AbstractXYDataset
    ...
    private int getOffSet(int series) {
        ...
        return (int) ((seriesFirstX - firstX) / diff);
    }
    ...
    public double getXValue(int series, int item) {
        ...
        return this.underlying.getXValue(series, newIndex);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.firstItemIndex == that.firstItemIndex &&
                this.windowCount == that.windowCount &&
