...
if [ $architecture = 'x86_64' ]; then
  VM_ARGS=$VM_ARGS" -XX:+UseCompressedOops -Xss32m "
else
  VM_ARGS=$VM_ARGS" -Xms2g -Xmx3g -Xss16m "
  architecture='x86_32'
fi
