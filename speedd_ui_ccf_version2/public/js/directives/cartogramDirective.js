app.directive('cartogramDirective', function ($parse) { // inspired by http://prag.ma/code/d3-cartogram/#popest/2010
            ...
            function colourCountries(countryArr, colour){
                ...
                countries.style("fill", function (d,i) {
                            if (found(d.id))
							    ...
							    return datax.get(d.id)? datax.get(d.id).colour:"white";//"#4D97B1"
                });
                */
                countries.attr("class", function (d,i) {
                            if (found(d.id))
                                return "countrySelected";
                            else
							    return "countryNormal";//"#4D97B1"
                });
